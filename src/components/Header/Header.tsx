...
import { FacebookIcon, GithubIcon, InstagramIcon, LinkedInIcon, StackOverflowIcon, MailIcon } from '../../common/icons'
...
const Header = ({data: {name, title, showProfilePic, cvLink, linkedIn, stackOverflow, facebook, instagram, github, mail}, modules}:IHeaderProps) => {
    return (
        <StyledHeader>
            <Navigation modules={modules} data={{name}} />
            ...
            {(github || linkedIn || instagram || facebook || stackOverflow || mail) && <StyledSocialLinks>
               {mail && <Link href={mail} isExternal={true}><MailIcon /></Link>}
